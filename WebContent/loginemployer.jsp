...
<head>
    ...
    <link rel="shortcut icon" href="http://www.sclance.com/pngs/job-png/job_png_733952.png">
    ...
    <div class="image">
        <div class="card">
            <div class="card-body">
                ...
                <input type="password" name="password" placeholder="  Password" ng-model="password" required><br>
                <%
                ...
                %>
                <center>
                    <button type="submit" class="btn btn-outline-primary">Log In
                            </button>
