    ...
    <div class="image">
        <div class="card">
            <div class="card-body">
                ...
                <form action="EmployerOtpEnterServlet" method="GET">
                <center>
                    <h5 class="card-title">JobShikari</h5>
                    <h4>Reset Password</h4><br>
                </center>
                
                <input type="password" name="otp" placeholder="  Enter Otp" ng-model="otp" required><br>
                <center>
                ...
                <div class="col-lg-12">
                    <ul class="list-unstyled list-inline social text-center">
                        ...
                        <li class="list-inline-item"><a href="..."><i class='fab fa-instagram'
                                    style='font-size:24px'></i></a></li>
                        <li class="list-inline-item"><a href="..." ><li class="list-inline-item"><a href="about_us.html"><i class="fa fa-info-circle" style="font-size:24px"></i></a></li></a></li>
                    </ul>
                </div>
            </div>
            <div class=about>
